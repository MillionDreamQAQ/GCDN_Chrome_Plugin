window.onload = function () {
  ...
  let crmButton = document.querySelector("#postauthor").appendChild(document.createElement("a"));
  crmButton.style.marginLeft = "10px";
  crmButton.style.color = "#0078d4";
  crmButton.style.textDecoration = "underline";
  crmButton.setAttribute("href", "https://developersolutions.crm5.dynamics.com/main.aspx?appid=69dffb8e-ae36-e811-817f-e0071b6927a1&forceUCI=1&pagetype=search&searchText=" + document.querySelector("#postauthor").innerText);
